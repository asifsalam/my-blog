...
<div class="sidebar">
	...
	{/if}
	{#if useTags == 'yes'}
		<KeyTags headingText={'Other tags'} tags={$tags} tagType="tag" />
	{/if}
</div>

<style>
	@import url('https://fonts.googleapis.com/css2?family=Crete+Round&family=Sanchez&family=Pridi:wght@200;300;400&display=swap');
